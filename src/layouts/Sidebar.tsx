...
export const Sidebar = memo(function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex flex-col border-r border-slate-800 bg-slate-950 transition-all duration-300 ease-in-out lg:static lg:z-auto',
      ...
      >
        ...
        <div
          className={cn(
            'flex h-16 items-center border-b border-slate-800 px-4 transition-all duration-300 justify-between',
        ...
        {!collapsed && (
          <div className="mx-3 mb-3 rounded-lg bg-slate-900 px-3 py-2">
            <p className="text-[10px] font-medium text-slate-400">
              {IMPLEMENTED_MODULES.size} of 8 modules active
            </p>
        ...
        <button
          ...
          className="hidden lg:flex absolute -right-3 top-20 h-6 w-6 items-center justify-center rounded-full border border-slate-700 bg-slate-900 text-slate-400 shadow-md transition-colors hover:bg-slate-800 hover:text-white"
        >
          {collapsed
